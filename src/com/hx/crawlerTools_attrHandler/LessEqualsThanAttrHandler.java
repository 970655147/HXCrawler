...
//gt(2), gt(2, 1), 2 > 1
public class LessEqualsThanAttrHandler extends OneOrTwoStringArgsAttrHandler {
	
	// 初始化
	public LessEqualsThanAttrHandler(String arg01, String arg02) {
		super(arg01, arg02);
	}
	public LessEqualsThanAttrHandler(String arg01) {
		this(arg01, Constants.HANDLER_UNDEFINED);
	}
	public LessEqualsThanAttrHandler() {
	...
	@Override
	public String name() {
		return Constants.LESS_EQUALS_THAN;
	}
}
